...
## Please make sure you are assigned to an [Issue](https://github.com/pattarai/ci-cd-github-actions/issues) before submitting a pull request

Go to the [issue](https://github.com/pattarai/ci-cd-github-actions/issues) page and either
...
```
git remote add upstream https://github.com/pattarai/ci-cd-github-actions.git
